...
<link href="<?php echo $this->templateurl(); ?><?php echo '/css/colors/'.$this->getParam('ca_colorVariation'); ?>-mobile.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $this->templateurl(); ?>/css/handheld/test.css" type="text/css" />
