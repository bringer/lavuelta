...
<body id="bd" class="fs<?php echo $this->getParam(JA_TOOL_FONT);?> <?php echo $this->browser();?> <?php if($this->getParam(ca_colorVariation)){ echo $this->getParam(ca_colorVariation); } ?>">
	<div id="ja-wrapper">
		<a name="Top" id="Top"></a>
