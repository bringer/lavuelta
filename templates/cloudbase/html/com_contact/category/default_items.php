...
<tr class="sectiontableentry">
	<td class="sectiontableentry<?php echo $item->odd; ?>" headers="Count">
	...
	<td height="20" class="sectiontableentry<?php echo $item->odd; ?>" headers="Name">
	...
	<td headers="Phone" class="sectiontableentry<?php echo $item->odd; ?>">
	...
	<td headers="Fax" class="sectiontableentry<?php echo $item->odd; ?>">
